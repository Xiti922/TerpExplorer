...
export const DEFAULT: RequestRegistry = {
  ...
  bank_supply_by_denom: { url: '/cosmos/bank/v1beta1/supply/by_denom?={denom}', adapter },
  ...
  gov_proposals_proposal_id: {
    url: '/cosmos/gov/v1/proposals/{id}',
    adapter,
  },
  gov_proposals_deposits: {
    url: '/cosmos/gov/v1/proposals/{id}/deposits',
    adapter,
  },
  gov_proposals_tally: {
    url: '/cosmos/gov/v1/proposals/{id}/tally',
    adapter,
  },
  gov_proposals_votes: {
    url: '/cosmos/gov/v1/proposals/{id}/votes',
    adapter,
  },
  ...
  staking_deletations: {
    url: '/cosmos/staking/v1/delegations/{delegator_addr}',
    adapter,
  },
  staking_delegator_redelegations: {
    url: '/cosmos/staking/v1/delegators/{delegator_addr}/redelegations',
    adapter,
  },
